...
call s:h("Search",        { "fg": s:darkred,    "bg": s:yellow })
call s:h("MatchParen",    { "fg": s:black,      "bg": s:purple ,      "format": "reverse" })
...
" customized
call s:h("StatusLine",    { "fg": s:darkblack,      "bg": s:orange })
call s:h("StatusLineNC",  { "fg": s:white,          "bg": s:warmgrey })
call s:h("TabLineFill",   { "fg": s:black,          "bg": s:warmgrey })
call s:h("TabLine",       { "fg": s:white,          "bg": s:warmgrey })
call s:h("TabLineSel",    { "fg": s:darkblack,      "bg": s:green,        "format": "bold" })
call s:h("TabLineInfo",   { "fg": s:white,          "bg": s:purple })
call s:h("iCursor",       { "fg": s:darkblack,      "bg": s:white })
" highlight function call in aqua
call s:h("jsFuncCall",          { "fg": s:aqua,   "format": "italic" })
call s:h("jsUndefined",         { "fg": s:red })
call s:h("jsFuncInitial",       { "fg": s:green })
" not show "~" in line number
" call s:h("NonText",       { "fg": s:lightblack })
